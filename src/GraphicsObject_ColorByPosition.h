...
{
public:
	GraphicsObject_ColorByPosition(Mesh * const Mesh, const ShaderObject * const pShaderObj);
	GraphicsObject_ColorByPosition(Model* const Model, const ShaderObject* const pShaderObj);
	...
	virtual ~GraphicsObject_ColorByPosition() = default;
