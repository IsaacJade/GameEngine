...
GLenum textureDataOpenGL::Get(textureData::TEXTURE_MAG_FILTER min)
{
	GLenum res;
...
GLenum textureDataOpenGL::Get(textureData::TEXTURE_MIN_FILTER min)
{
	GLenum res;
...
GLenum textureDataOpenGL::Get(textureData::TEXTURE_WRAP w)
{
	GLenum res;
