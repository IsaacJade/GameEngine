...
namespace Azul
{
	...
	public:
		...
		GraphicsObject_WireframeConstantColor(Mesh * const mesh, const ShaderObject * const pShaderObj, const Vect &wireColor);
		GraphicsObject_WireframeConstantColor(Model* const Model, const ShaderObject* const pShaderObj, const Vect& wireColor);
