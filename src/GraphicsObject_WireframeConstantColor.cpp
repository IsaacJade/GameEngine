...
using namespace Azul;
	...
	GraphicsObject_WireframeConstantColor::GraphicsObject_WireframeConstantColor(Mesh *const pMesh, const ShaderObject *const pShaderObj, const Vect &wireColor)
	...
	Azul::GraphicsObject_WireframeConstantColor::GraphicsObject_WireframeConstantColor(Model* const Model, const ShaderObject* const pShaderObj, const Vect& wireColor)
